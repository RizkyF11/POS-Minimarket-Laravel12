                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                @if(Auth::check())
                                <span class="hidden-xs">{{ucfirst(strtolower(Auth::user()->nama_user))}}</span>
                                @else
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        <strong>{{ucfirst(strtolower(Auth::user()->nama_user))}}</strong> - {{ucfirst(strtolower(Auth::user()->role))}}
                                    </p>
                                    @endif
                                </li>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        @if(Auth::check())
                        <p>{{ucfirst(strtolower(Auth::user()->nama_user))}}</p>
                        @endif
                    </div>
                </div>
                <!-- search form -->
